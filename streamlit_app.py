...
# ===============================
# ChartIntel — Streamlit (single file)
# ===============================
# - Upload a TradingView screenshot
# - Detect simple bias from right-side slope
# - Find recent swing high/low from image edges (no OpenCV)
# - Recommend BUY/SELL/WAIT + Entry/Stop/TPs
# - Optional last_price converts pixel distances → price
# ===============================
...
with st.expander("How to use (3 quick steps)", expanded=True):
    st.markdown(
        ...
        3) Read the **Trade Plan** box for Entry/Stop/TPs and a BUY/SELL/WAIT call.
        """
    )
...
if recommendation == "WAIT":
    ...
    st.success(f"Place **{side_word}** at **{entry:.4f}**, Stop-Loss at **{stop:.4f}**, TP1 **{tp1:.4f}**, TP2 **{tp2:.4f}**.")
